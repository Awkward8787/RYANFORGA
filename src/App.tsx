        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl font-display font-black mb-6 leading-tight">
              MARCUS RYAN <br />
              <span className="text-ga-red">FOR STATE HOUSE</span>
            </h1>
          ...
          >
            ...
            <div className="space-y-6 text-ga-navy/80 leading-relaxed text-lg">
              ...
              <p>
                ...
                the challenges facing our state. He's running for Georgia State House Representative to ensure 
